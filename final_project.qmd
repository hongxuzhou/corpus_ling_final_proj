...
This one is hard, usually requires extensive manual annotation fro accurate dialogue extraction and social network analysis. Consider - remove it - use simple rule-based approach (quotation mark maybe?) - use machine learning
